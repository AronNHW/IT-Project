  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .auth-title {
      margin: 0 0 4px;
      font-weight: 700;
      color: #ffffff !important; /* pastikan putih & tidak tertimpa Bootstrap */
    }
    ...
    /* Link & teks di bagian bawah card */
    .auth-footer {
      text-align: center;
      color: #94a3b8;
      padding: 0 0 18px;
...
<body>
  ...
  <main class="card auth-card" role="main" aria-labelledby="login-title">
    <header class="card-header">
      <img src="{{ asset('assets/image/logo_hima.png') }}" alt="Logo HMTI" class="auth-logo"/>
      <h2 id="login-title" class="auth-title">Masuk HIMA-TI</h2>
      <p class="auth-subtitle">Silakan login menggunakan akun Anda</p>
    </header>
    ...
    <section class="card-body">
      ...
      {{-- Login via Google --}}
      <div class="mt-3">
        <a href="{{ url('auth/google') }}" class="google-btn" aria-label="Masuk dengan Google">
    ...
    <div class="auth-footer">© 2025 HIMA-TI Politala</div>
  </main>
