...
<style>
    ...
    .form-group input, .form-group select, .form-group textarea { width: 100%; padding: 0.75rem; border: 1px solid #e5e7eb; border-radius: 0.375rem; }
...
@section('content')
    <div class="form-container">
        ...
        <form action="{{ route('admin.mahasiswa-bermasalah.update', $pengaduan) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @include('admin.bermasalah._form', ['pengaduan' => $pengaduan])
        </form>
    </div>
@endsection
